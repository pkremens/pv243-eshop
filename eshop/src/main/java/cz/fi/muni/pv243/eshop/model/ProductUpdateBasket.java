 ...
 */
public class ProductUpdateBasket implements Serializable {
	 ...
	 * @param productId
	 */
	public ProductUpdateBasket(HtmlOutputText productId, int quantity) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProductUpdateBasket other = (ProductUpdateBasket) obj;
		if (productId == null) {
